...
@section('title')
    {{ $property->property_name }}-Ishal Realestate
@endsection
                    ...
                    <div class="left-column pull-left clearfix">
                        ...
                        <div class="author-info clearfix">
                            <div class="author-box pull-left">
                                ...
                                <figure class="author-thumb"><img src="{{ url('upload/Musfikur.jpg') }}" alt=""></figure>
                                <h6>Admin </h6>
                ...
                <div class="carousel-inner">
                    <div class="single-item-carousel owl-carousel owl-theme owl-dots-none">
                    	@foreach($multiImage as $img)
                        	<figure class="image-box"><img src="{{ asset($img->photo_name) }}" alt="MultiImage"></figure>
                        @endforeach
                            ...
                            <div class="details-box content-widget">
                                ...
                                <ul class="list clearfix">
                                    ...
                                    <li>Year Post: <span>{{ $property->created_at->format('d M Y') }}</span></li>
                                </ul>
                            </div>
                            ...
                            <div class="location-box content-widget">
                                ...
                                <div class="google-map-area">
                                    <div 
                                        ...
                                        data-map-title="{{ $property->address }}" 
                                        data-map-zoom="12" 
                                        data-markers='{
                                            "marker-1": [{{ $property->latitude }}, {{ $property->longitude }}, "<h4>{{ $property->state }}</h4><p>{{ $property->address }}</p>","{{ asset('frontend/assets/images/icons/map-marker.png') }}"]
                                        }'>
                            ...
                            <div class="statistics-box content-widget">
                                ...
                                <figure class="image-box">
                                    <iframe width="700" height="415" src="{{ $property->property_video }}" title="Video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </figure>
                            </div>
                                ...
                                <div class="author-box">
                                    @if($property->agent_id == NULL)
                                        ...
                                        <div class="inner">
                                            <h4>Admin </h4>
                                            <ul class="info clearfix">
                                                <li><i class="fas fa-map-marker-alt"></i> House: 11, Road: 2, Block: C, Pallabi, Mirpur: 12, Dhaka: 1216.</li>
                                                <li><i class="fas fa-phone"></i><a href="tel:01625983433">01625983433 </a></li> 
                                            </ul>
                                        </div>
                                    @else
                                        <figure class="author-thumb"><img src="{{ (!empty($property->user->photo)) ? url('upload/agent_images/'.$property->user->photo) : url('upload/no_image.jpg') }}" alt=""></figure>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="{{ asset($item->property_thumbnail) }}" alt="{{ $item->property_name }}"></figure>

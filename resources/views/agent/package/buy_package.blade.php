...
@php 
  $id = Auth::user()->id;
  $packagehistory = App\Models\PackagePlan::where('user_id',$id)->first();
  $uid = $packagehistory->package_name;
@endphp
                ...
                <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="d-grid">
                      	<a href="{{ route('agent.add.property') }}" class="btn btn-primary mt-4">Start Now </a>
                      </div>
                    </div>
                  </div>
                </div>

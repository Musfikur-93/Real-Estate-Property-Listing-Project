          ...
          <div class="card-body">
            <div class="container-fluid d-flex justify-content-between">
              <div class="col-lg-3 ps-0">
                ...
                <p>{{ $data->name }},<br> {{ $data->email }},<br> {{ $data->phone }}, <br> {{ $data->address }}</p>
              </div>
            ...
            <div class="container-fluid w-100">
              <button class="btn btn-primary float-end mt-4 ms-2 mb-2"><i data-feather="send" class="me-3 icon-md"></i>Send Invoice</button>
            </div>
          </div>
        </div>
      </form>

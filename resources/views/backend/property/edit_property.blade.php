                            ...
                            <form method="post" action="{{ route('update.property') }}" id="myForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            <label class="form-label">Porperty Name</label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="agent_id" id="exampleFormControlSelect1">
                                                ...
                                                <option value="{{ $aagent->id }}" {{ $aagent->id == $property->agent_id ? 'selected' : '' }}>{{ $aagent->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div><!-- Col -->
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="short_descp" id="exampleFormControlTextarea1" rows="3">{{ $property->short_descp }}</textarea>
                                    </div>
                                </div><!-- Col -->
                    ...
                    <div class="card-body">
                        <h6 class="card-title">Edit Main Thumbnail Image </h6>
                            <form method="post" action="{{ route('update.property.thumbnail') }}" id="myForm" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-primary">Save Thumbnail</button>
                            </form>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                <td class="py-1">
                                                    <img src="{{ asset($img->photo_name) }}" style="width: 50px; height: 50px;" alt="image">
                                                </td>
                                                <td>
                    ...
                    <div class="card-body">
                        <h6 class="card-title">Edit Property Facility </h6>
                            <form method="post" action="{{ route('update.property.facilities') }}" id="myForm" enctype="multipart/form-data">
                                ...
                                @endforeach
                                <br>
                                <button type="submit" class="btn btn-info">Save Facility</button>
                            </form>
                        </div>
                    </div>
                </div>
...
</div> <!-- End add multiple selection -->     
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                property_thumbnail: {
                    required : 'Please Select Property Main Thumbnail',
                },
                ptype_id: {
                    required : 'Please Select Property Type Id',
                },

        ...
        <div class="row profile-body">
            ...
            <div class="card rounded">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  <div>
                    <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="admin profile">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            ...
            <div class="mb-3">
              ...
              <img class="wd-80" id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="admin profile">
            </div>

...
<p><strong>Hello Sir </strong><br/><strong>Your Request is confirm on this data. </strong></p>
	...
	<h4> Tour Date : {{ $schedule['tour_date'] }} </h4>
	<h4> Tour Time : {{ $schedule['tour_time'] }}</h4>

<p>Ishal RealEstate is one of the well known organization, we are creating the dream address. We belive the quality and get the faith of our clients.<br/>If you want to get know more information please contact with us and visit our project.</p>
</div>
...
<div class="bee-block bee-block-2 bee-text">
<div class="bee-text-content" style="line-height: 150%; font-size: 12px; font-family: inherit; color: #fafafa;">
<p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">House 11, Road 2, Block C, Mirpur 12, Dhaka</span></p>
<p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">ishal@irealestate.com </span></p>
<p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">(+880) 1625983433 </span></p>
</div>
</div>
</div>
...
<p style="font-size: 14px; line-height: 16px; text-align: center;"><span style="font-size: 12px; line-height: 14px;">2023 © All Rights Reserved</span></p>
</div>
</div>
</div>
</div>
...
<div class="bee-icon-image"><a href="http://127.0.0.1:8000/" target="_blank"><img alt="" height="32px" src="images/bee.png" width="auto"/></a></div>
<div class="bee-icon-label bee-icon-label-right"><a href="http://127.0.0.1:8000/" target="_blank"></a></div>
</div>
</div>
</div>
</div>

...
//Admin Login Route without group middleware

Route::get('/admin/login', [AdminController::class, 'AdminLogin'])->name('admin.login')->middleware(RedirectIfAuthenticated::class);

//End Admin Login Route without group middleware


//Agent Login Route without group middleware

Route::get('/agent/login', [AgentController::class, 'AgentLogin'])->name('agent.login')->middleware(RedirectIfAuthenticated::class);
Route::post('/agent/register', [AgentController::class, 'AgentRegister'])->name('agent.register');

//EndAgent Login Route without group middleware


// Admin Property type Group Middleware
Route::middleware(['auth','roles:admin'])->group(function(){
    ...
    Route::controller(RoleController::class)->group(function(){
        ...
        Route::get('/add/roles/permission', 'AddRolePermission')->name('add.role.permission');
...
}); // End Property type Group Admin Middleware


// Agent Property Group Middleware
Route::middleware(['auth','roles:agent'])->group(function(){

    // All Agent Property Route
    ...
    Route::controller(AgentPropertyController::class)->group(function(){
        ...
        Route::get('/agent/package/history/{id}', 'AgentPackageInvoice')->name('agent.package.invoice');

    }); // End Agent Buy Package Route
...
//Property Schedule Route
Route::post('/store/schedule', [IndexController::class, 'StoreSchedule'])->name('store.schedule');

// All Property Type Route
Route::get('/all/type/list', [IndexController::class, 'AllTypeList'])->name('all.type.list');

// All Property List Route
Route::get('/all/property/list', [IndexController::class, 'AllPropertyList'])->name('all.property.list');

// All Agent List Route
Route::get('/agent/list', [IndexController::class, 'AgentList'])->name('agent.list');
